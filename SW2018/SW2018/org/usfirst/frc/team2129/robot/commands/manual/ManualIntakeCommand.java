...
//		Robot.s_IntakeSubsystem.setArmsRaw(leftspeed*ldir, rightspeed*rdir);
		...
		if(OI.leftStick.getRawButton(4)) {
			...
			if(OI.rightStick.getRawButton(3)) Robot.s_IntakeSubsystem.setArmsRaw(-armSpeed, -armSpeed);
			else if (OI.rightStick.getRawButton(2))Robot.s_IntakeSubsystem.setArmsRaw(armSpeed, armSpeed);
			else Robot.s_IntakeSubsystem.setArmsRaw(0, 0);
			
			if(OI.rightStick.getRawButton(4)) Robot.s_IntakeSubsystem.setIntakesRaw(1, 1);
			else if (OI.rightStick.getRawButton(5))Robot.s_IntakeSubsystem.setIntakesRaw(-1, -1);
			else Robot.s_IntakeSubsystem.setIntakesRaw(0, 0);
